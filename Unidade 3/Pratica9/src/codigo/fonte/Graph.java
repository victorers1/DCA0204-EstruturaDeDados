...
public class Graph {
	...
	final int n; 
	final int m;
	final protected ArrayList<Integer>[] succ; // Isto é um vetor de ArrayList
	...
	public Graph(int n, int m) {
		...
		this.weights = new HashMap<>(c * n);

		for (int k = 0; k < n; k++) {
			succ[k] = new ArrayList<>();
			pred[k] = new ArrayList<>();
		}
	}
	...
	public Graph reverse() {
		HashMap<Arc, Integer> map = new HashMap<>(c * n);
		for (int i = 0; i < n; i++) {
	...
	public void drawPath(Fenetre f, int[] predF, int[] predB, int x, int i, int j) {
		...
		// petit graphe
		g = new Graph("C:\\Users\\ana\\Documents\\OneDriveVictor\\OneDrive\\UFRN\\Estrutura de Dados\\Unidade 3\\pratica9\\Pratica9\\src\\codigo\\fonte\\mini.gr");
		System.out.println(g);

		// gros graphe
		g = new Graph("C:\\Users\\ana\\Documents\\OneDriveVictor\\OneDrive\\UFRN\\Estrutura de Dados\\Unidade 3\\pratica9\\Pratica9\\src\\codigo\\fonte\\USA-road-d-NY.gr");
		g.setCoordinates("C:\\Users\\ana\\Documents\\OneDriveVictor\\OneDrive\\UFRN\\Estrutura de Dados\\Unidade 3\\pratica9\\Pratica9\\src\\codigo\\fonte\\USA-road-d-NY.co");
		Fenetre f;
		f = new Fenetre("C:\\Users\\ana\\Documents\\OneDriveVictor\\OneDrive\\UFRN\\Estrutura de Dados\\Unidade 3\\pratica9\\Pratica9\\src\\codigo\\fonte\\NY_Metropolitan.png", "Dijkstra", -73.9987, -73.9437, 40.7523, 40.78085);
		g.drawGraph(f);
	}
}