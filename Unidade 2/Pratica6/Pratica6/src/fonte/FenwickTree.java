...
public class FenwickTree {
    ...
    /**
     * Variáveis. value contém: Para uma folha, o valor a que ela se refere.
     * Para um nó, a soma dos valores das folhas abaixo dele. leftsize contém:
     * Para uma folha, o valor 0. Para um nó, o número de folhas na sub-árvore
     * esquerda. left e right contém: Para uma folha, null. Para um nó,
     * ponteiros para as sub-árvores esquerda e direita, respectivamente.
     */
    public int value;
    public int leftsize;
    ...
    public String toString() {
        ...
        //s = (left==null || right==null)? s+s.substring(0, s.length()-2)+"]": s+"]" ; // retira o espaço e a vígula do final
        s = s + "]";
        return s;*/
    }
    ...
    public static void test3(){
        System.out.println("Construção da minha árvore: " + new FenwickTree(1, new FenwickTree(1), new FenwickTree(3)));
    }
